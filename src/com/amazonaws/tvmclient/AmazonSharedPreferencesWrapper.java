...
public class AmazonSharedPreferencesWrapper 
{
    ...
    private static final Logger log4j = 
    		Logger.getLogger(AmazonSharedPreferencesWrapper.class);
    ...
    /**
     * Gets the AWS Access Key, AWS Secret Key and Security Token currently stored in Shared Preferences.  
     * Then creates a Credentials object
    ...
    public static AWSCredentials getCredentialsFromSharedPreferences( SharedPreferences sharedPreferences ) 
    {
        ...
        log4j.debug("getCredentialsFromSharedPreferences£¨£©" 
                  + ", accessKey = " + accessKey 
                  + ", secretKey = " + secretKey 
     ...
     */
    public static void storeCredentialsInSharedPreferences( SharedPreferences sharedPreferences, 
                                                            String accessKey, 
                                                            String secretKey, 
