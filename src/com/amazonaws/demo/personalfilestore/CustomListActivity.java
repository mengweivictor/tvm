...
public abstract class CustomListActivity extends AlertActivity 
{
    ...
    private static final String LOG_TAG = "CustomListActivity";
    private static final Logger log4j = Logger.getLogger(CustomListActivity.class);
	
	protected Handler mHandler;
	protected ListView itemList;
	protected TextView loadingText;
	protected Button addText;
	protected Button selectImage;
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        addText     = (Button)findViewById(R.id.add_item);  
        selectImage = (Button)findViewById(R.id.select_item);
    }
    	...
    	Thread t = new Thread() 
    	{
    		...
    		public void run()
    		{
    			...
    			catch (AmazonServiceException e) 
    			{
    				...
    				if("InvalidClientTokenId".equals(errorCode) 
