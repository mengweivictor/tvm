...
public class Login extends AlertActivity 
{
	...
	private static final Logger log4j = Logger.getLogger(Login.class);
	...
	public void wireButtons() 
	{
    	okButton.setOnClickListener(new View.OnClickListener() 
    	{
			...
			public void onClick(View v) 
			{
				...
				{
					Response response = 
					    S3PersonalFileStore.clientManager.login( 
    	...
    	registerButton.setOnClickListener(new View.OnClickListener() 
    	{
			...
			public void onClick(View v) 
			{
				try
				{
                    String registerURL = (PropertyLoader.getInstance().useSSL() ? "https://" : "http://" ) 
